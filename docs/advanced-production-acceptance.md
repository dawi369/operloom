...
conformance does not validate these hosted capabilities.
...
- [ ] Retained data, then connections, then mutation are enabled and accepted in
      an isolated non-customer workspace before claiming those experimental capabilities are production-accepted.
